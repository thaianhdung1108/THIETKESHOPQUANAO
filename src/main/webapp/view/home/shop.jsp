				...
				<div class="row">
					...
					<div class="col-md-9 col-sm-12">
						...
						<div class="featured-products-area">
								...
								<div class="col-md-12">
									<div class="filter-menu">
										...
										<div class="shop-pagination">
											<nav>
												<ul>
													<li><a href="/home/shop?p=${page.number-1}"><i class="fa fa-caret-left"></i></a></li>
													<li><a href="/home/shop?p=0">1</a></li>
													<li><a href="/home/shop?p=1">2</a></li>
													<li><a href="/home/shop?p=${page.number+1}"><i class="fa fa-caret-right"></i></a></li>
												</ul>
											</nav>
										</div>
									</div>
							...
							<input class="form-control "  placeholder="Search" name="keywords" value="${keywords }">
											...
											<div class="single-product">
												<div class="product-img">
													...
													<div class="pro-actions">
														<a class="action-btn action-btn-1" href="/cart/add/${item.id }"><i class="pe-7s-cart"></i>Add to Cart</a>
