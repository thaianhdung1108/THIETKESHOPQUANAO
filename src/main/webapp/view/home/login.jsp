						...
						<div class="col-md-6">
							<form action="/account/login" method="post">
								<div class="registered-customers margin-65">
									<h2 class="title-3">REGISTERED CUSTOMERS</h2>
									<div class="registered">
										<p>If you have an account with us, Please log in.</p>
										<div class="row">
											<div class="col-md-12">
												<input type="text" class="custom-form" name="username" placeholder="Username" />
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
						...
						<div class="col-md-6">
							<form action="#">
								<div class="new-customers margin-65">
									...
									<div class="row">
										<div class="col-sm-12">
											<input type="text" class="custom-form" placeholder="Username" />
										</div>
									...
									<div class="row">
										<div class="col-sm-12">
											<input type="text" class="custom-form" placeholder="Fullname" />
										</div>
									</div>
									<div class="row">
										<div class="col-sm-12">
