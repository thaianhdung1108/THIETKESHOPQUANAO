			...
			<div id="list">
				<ul class="nav flex-column">
					...
					<li class="nav-item"><a href="/home/admin/accounts"
						class="nav-link active"><i class="fa fa-users"></i>Accounts</a></li>
					...
					<nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
							...
							<button class="nav-link" id="nav-profile-tab"
								...
								role="tab" aria-controls="nav-profile" aria-selected="false">Account</button>
										...
										<c:forEach var="item" items="${items }">
											<tbody>
												<tr>
													...
													<td>${item.photo }</td>
													<td><a
														href="/home/admin/accounts/edit/${item.username}">Edit</a></td>
						...
						<div class="tab-pane fade" id="songkhoe" role="tabpanel"
							...
							<div class="container">
								<div class="panel panel-default">
									...
									<form:form action="/home/admin/accounts" modelAttribute="item">
										...
										<div class="form-group">
											<div class="form-group col-md-6">
												<label for="inputEmail4">Activated</label>
												<form:input path="activated" class="form-control" />
											</div>
										</div>
										<div class="form-group">
											<div class="form-group col-md-6">
										...
										<button type="submit" class="btn btn-primary"
											formaction="/home/admin/accounts/create">Create</button>
										<button type="submit" class="btn btn-primary"
											formaction="/home/admin/accounts/update">Update</button>

										<button type="submit" class="btn btn-primary"
											formaction="/home/admin/accounts/delete/${item.username}">Delete</button>
										<button type="submit" class="btn btn-primary"
											formaction="/home/admin/accounts">Reset</button>
