			...
			<div id="list">
				<ul class="nav flex-column">
					...
					<li class="nav-item"><a href="/home/admin/products"
						class="nav-link active"><i class="fa fa-inbox"></i>Products</a></li>
										...
										<c:forEach var="item" items="${items }">
											<tbody>
												<tr>
													...
													<td>${item.price }</td>
													<td>${item.category }</td>
													<td><a href="/home/admin/products/edit/${item.id}">Edit</a></td>
						...
						<div class="tab-pane fade" id="songkhoe" role="tabpanel"
							...
							<div class="container">
								<div class="panel panel-default">
									...
									<form:form action="/home/admin/products" modelAttribute="item">
										...
										<div class="form-group">
											<div class="form-group col-md-6">
												<label for="inputEmail4">CreateDate</label>
												<form:input path="createDate" class="form-control" />
											</div>
										</div>
										<div class="form-group">
											<div class="form-group col-md-6">
												<label for="inputEmail4">Image1</label>
												<form:input path="image1" class="form-control" />
											</div>
										</div>
										<div class="form-group">
											<div class="form-group col-md-6">
												<label for="inputEmail4">Image2</label>
										...
										<button type="submit" class="btn btn-primary"
											formaction="/home/admin/products/create">Create</button>
										<button type="submit" class="btn btn-primary"
											formaction="/home/admin/products/update">Update</button>

										<button type="submit" class="btn btn-primary"
											formaction="/home/admin/products/delete/${item.id}">Delete</button>
										<button type="submit" class="btn btn-primary"
											formaction="/home/admin/products">Reset</button>
