...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <body>
        ...
        <section class="content">
			<!-- ABOUT-AREA START -->
			<div class="about-area margin-70">
				<div class="container">
					<div class="about-us-description">
						<div class="row">
							...
							<div class="col-md-4">
								<div class="about-briefing">
									<h2 class="title-3">Who We Are</h2>
									<p>Lorem Ipsum is simply dummy text of the printed and typesetting industry. Lorem Ipsum has been industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
									<p>But also the leap into electronic typesett, remaini essentially unchanged. It was populariseding in the 1960 with the release of Letraset sheets containing Lorem Ipsum passages.</p>
								</div>
							</div>
							<div class="col-md-4">
								<div class="about-briefing">
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="single-team">
									...
									<div class="single-team-brief">
										<h4>Steven Curtis</h4>
										<h5>Manager</h5>
										<p>Lorem Ipsum is simply dummy text of the printing and type setting industry. Lorem Ipsum has been the industry. when an unknown printer took a galley of type and scrambled.</p>
									...
									<div class="single-team-brief-2 text-right">
										<h4>Steven Curtis</h4>
									</div>
								</div>
							</div>
